 ...
 */
public final class PCAARMAVolumeProfileConsideringMarketPredictor 
        extends DynamicARMAVolumeProfilePredictor{
    private static final Logger log = Logger.getLogger(
            PCAARMAVolumeProfileConsideringMarketPredictor.class.getPackage()
                    .getName());
    //
    // Public methods ---------------------------------------
    //
     ...
     */
    public PCAARMAVolumeProfileConsideringMarketPredictor(
            final CalUtils.InstantGenerator instantGenerator,
            final double minimumVariance, final String[] symbols, 
            final String consideredSymbol) {
        super(new PCAVolumeProfileConsideringMarketPredictor(
                instantGenerator, minimumVariance, symbols),
            instantGenerator, consideredSymbol, 100);
    }
